...
import com.example.prm392_group2_shoesordersystem.service.TrackOrderActivity;
...
public class ListCustomerOrderAdapter extends RecyclerView.Adapter<ListCustomerOrderAdapter.OrderViewHolder> {
    ...
    @NonNull
    @Override
    public ListCustomerOrderAdapter.OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_customer_order, parent, false);
        return new ListCustomerOrderAdapter.OrderViewHolder(view);
    }

    // Lấy dữ liệu từ danh sách Order và hiển thị nó trong ViewHolder.
    @Override
